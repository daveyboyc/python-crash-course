...
def check_keydown_events(event, ai_settings, screen, stats, ship, aliens, bullets):
	if event.key == pygame.K_RIGHT:
		...
		p_press(ai_settings, screen, stats, ship, aliens, bullets)
...
def p_press(ai_settings, screen, stats, ship, aliens, bullets):
	if not stats.game_active:
		start_game(ai_settings, screen, stats, ship, aliens, bullets)
	else:
		pass
...
def update_bullets(ai_settings, screen, ship, aliens, bullets):
	...
	# delete bullets fired off screen to save memory
...
def get_number_aliens_x(ai_settings, alien_width):
	"""Determine aliens that fit in row"""
...
def create_fleet(ai_settings, screen,ship, aliens):
	"""Creat fleet"""
	# Creat alien and find number of them in a row
	# spacing between each one = one alien width
	alien = Alien(ai_settings, screen)
...
def check_fleet_edges(ai_settings, aliens):
	...
	"""change direction where appropriate"""
